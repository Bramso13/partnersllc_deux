...
export function StepValidationSection({ dossierId }: StepValidationSectionProps) {
  ...
  const fetchStepInstances = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/dossiers/${dossierId}/validation`);
      ...
      console.error("Error fetching step instances:", err);
