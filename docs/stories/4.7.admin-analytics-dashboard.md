...
- [ ] Create analytics dashboard page (AC: 1)
  - [ ] Build page at `/admin/analytics`
  - [ ] Set up responsive grid layout for metric sections
  - [ ] Add section headings and organization
- [ ] Build Revenue Metrics section (AC: 2)
  - [ ] Calculate Total Revenue (sum of all PAID orders)
  - [ ] Calculate Revenue This Month
  - [ ] Create line chart for daily revenue (last 90 days)
  - [ ] Create pie/bar chart for revenue by product
  - [ ] Calculate Average Order Value
  - [ ] Display as metric cards
- [ ] Build Conversion Metrics section (AC: 3)
  - [ ] Calculate Payment Link Conversion Rate
  - [ ] Calculate Registration → Payment Conversion
  - [ ] Calculate SUSPENDED User Recovery Rate
  - [ ] Create funnel chart visualization
  - [ ] Display metrics as percentage cards
- [ ] Build Dossier Performance section (AC: 4)
  - [ ] Calculate Total Dossiers all time
  - [ ] Calculate Active Dossiers count
  - [ ] Calculate Completed Dossiers This Month
  - [ ] Calculate Average Time to Completion
  - [ ] Calculate Completion Rate by Product
  - [ ] Create bottleneck analysis query
  - [ ] Display results in table or chart format
- [ ] Build Agent Performance section (AC: 5)
  - [ ] Calculate Documents Reviewed (total and per agent)
  - [ ] Calculate Average Review Time
  - [ ] Create workload distribution chart (dossiers per agent)
  - [ ] Create leaderboard (top reviewers by volume)
  - [ ] Create leaderboard (fastest reviewers)
- [ ] Build Document Metrics section (AC: 6)
  - [ ] Calculate Approval Rate (% approved on first review)
  - [ ] Query rejection reasons from database
  - [ ] Create grouped bar chart for rejection reasons
  - [ ] Calculate Average Versions per Document
  - [ ] Display quality indicator
- [ ] Implement date range selector (AC: 7)
  - [ ] Create date range selector component
  - [ ] Add preset options: Last 7 days, Last 30 days, Last 90 days, All Time
  - [ ] Add custom date range picker
  - [ ] Apply selected range to all metric calculations
...
- [ ] Set up auto-refresh (AC: 9)
  - [ ] Implement 5-minute interval refresh
  - [ ] Refetch all metric calculations
  - [ ] Optionally use Supabase Realtime for real-time updates
  - [ ] Show last refresh timestamp
- [ ] Implement drill-down functionality (AC: 11)
  - [ ] Add click handlers to chart elements
  - [ ] Filter all metrics when chart segment clicked
  - [ ] Update URL params with filter state
  - [ ] Show active filter indicator
  - [ ] Allow clearing drill-down filter
- [ ] Build responsive chart layouts (AC: 10)
  - [ ] Ensure all charts responsive to screen size
  - [ ] Test on mobile, tablet, desktop
  - [ ] Adjust chart dimensions based on viewport
- [ ] Add empty states for new installations (AC: 12)
  - [ ] Detect if no data exists
  - [ ] Show sample/mock data visualizations
